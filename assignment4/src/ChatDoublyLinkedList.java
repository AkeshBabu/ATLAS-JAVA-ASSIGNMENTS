...
public class ChatDoublyLinkedList {
    ...
    void deleteMessage(Message message){
        if (head == null || message == null) {
            return;
        }
        if (head == message) {
            head = message.nextMessage;
        }
        if (message.nextMessage != null) {
            message.nextMessage.previousMessage = message.previousMessage;
        }
        if (message.previousMessage != null) {
            message.previousMessage.nextMessage = message.nextMessage;
        }
    }
   // }
